...
function Footer() {
    return (
        <footer className="text-center p-4 flex flex-row justify-start items-center">
            ...
            <a className="flex items-center hover:scale-90 transition-all duration-300 ease-in-out cursor-pointer" href="/"><FaArrowRight className="scale-90 mr-1" />Home</a>
                <a className="flex items-center hover:scale-90 transition-all duration-300 ease-in-out cursor-pointer" href="https://api.originalflix.dev"><FaArrowRight className="scale-90 mr-1" />Documentation</a>
                <a  className="flex items-center hover:scale-90 transition-all duration-300 ease-in-out cursor-pointer" href="https://api.originalflix.dev/redoc"><FaArrowRight className="scale-90 mr-1" />Redoc</a>
                <div className="flex flex-col justify-start items-start h-full mt-2 text-sm text-dark">
                    <p>Maintained by <a href="https://linkedin.com/in/rajveersodhi" target="_blank" className="hover:underline"><strong>Rajveer Sodhi</strong></a> via <a href="https://github.com/rajveersodhi" className="hover:underline" target="_blank"><strong>GitHub</strong></a>.</p>
